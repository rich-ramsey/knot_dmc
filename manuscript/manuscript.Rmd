...
Importantly, given that we were interested in the mechanisms that underlie training vs. no-training and different types of training (linguistic vs. action vs. both), only the post-training session was necessary to capture and quantify these effects. Indeed, Cross and colleagues (2012), in their original study, included only results from the post-training session in their final analysis, as this session is thought to be more consistent and reflect the participants' learned state [@weisberg2007]. All other aspects of the pre-registration were unchanged. In addition, all raw data, including for the pre-training session, and analysis code used in this paper have been made available on the open science framework (see here: [https://osf.io/ea6gk/](https://osf.io/ea6gk/)).
