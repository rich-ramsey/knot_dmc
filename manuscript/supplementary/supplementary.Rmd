...
```{r descriptive-table}
day1v5_group <- read_csv("../../data/processed/data1v5_group.csv") |>
...
```{r group-lba-table}
group_q <- read_csv("../../data/summary/group_q.csv") |> 
...
contrasts_q <- read_csv("../../data/summary/contrasts_q.csv") |> 
  mutate(day = factor(day))
...
day_contrasts_q <- read_csv("../../data/summary/day_contrasts_q.csv")
