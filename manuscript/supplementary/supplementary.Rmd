...
(1 + training type | pid)$$ *Note:* RT = reaction time (ms); acc= accuracy (0,1); training type = training condition (untrained vs. naming vs. tying vs. both); pid = subject/participant identifier; ndt = non-decision time.
