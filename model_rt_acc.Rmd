...
# b2 <- readRDS("models/manifest/b2.rds")
...
# ab2 <- readRDS("models/manifest/ab2.rds")
...
p_chains1
# save it
ggsave ("figures/manifest/b3_chains.jpeg",
        width = 8, height = 6)
```
...
ggsave("figures/manifest/b3_diag.jpeg",
       width = 8, height = 6)
```
...
p_chains2
# save it
ggsave ("figures/manifest/ab3_chains.jpeg",
        width = 8, height = 6)
```
...
ggsave("figures/manifest/ab3_diag.jpeg",
       width = 8, height = 6)
```
